...
public class NotificationDetails implements Serializable {
    ...
    private static final String CUSTOM_AVATAR_BITMAP_SOURCE = "customAvatarBitmapSource";
    ...
    private static void readStyleInformation(
        ...
        if (notificationDetails.style == NotificationStyle.Default) {
            ...
            notificationDetails.styleInformation = defaultStyleInformation;
        } else if (notificationDetails.style == NotificationStyle.CustomAvatar) {
            readCustomAvatarStyleInformation(notificationDetails, styleInformation, defaultStyleInformation);
        }
    }
    ...
    private static void readCustomAvatarStyleInformation(
            NotificationDetails notificationDetails,
            Map<String, Object> styleInformation,
            DefaultStyleInformation defaultStyleInformation) {
        Object customAvatar = styleInformation.get(CUSTOM_AVATAR);
        BitmapSource customAvatarBitmapSource = null;
        if(styleInformation.containsKey(CUSTOM_AVATAR_BITMAP_SOURCE)) {
            Integer customAvatarBitmapSourceArgument = (Integer) styleInformation.get(CUSTOM_AVATAR_BITMAP_SOURCE);
            customAvatarBitmapSource = BitmapSource.values()[customAvatarBitmapSourceArgument];
        }
        notificationDetails.styleInformation = new CustomAvatarStyleInformation(
                customAvatar,
                customAvatarBitmapSource,
                defaultStyleInformation.htmlFormatTitle,
                defaultStyleInformation.htmlFormatBody
        );
    }
